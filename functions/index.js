...
// ============================================================================
// EXAMPLE: New Custom Function
// ============================================================================

/**
 * Example: Get total statistics
 *
 * Endpoint: GET /apiStats
 *
 * Example:
 *   GET https://us-central1-assignment-cfc8f.cloudfunctions.net/apiStats
 *
 * Response:
 *   {
 *     success: true,
 ...
 *   }
 */
exports.apiStats = functions.https.onRequest(async (req, res) => {
  // Enable CORS
  res.set('Access-Control-Allow-Origin', '*')
  res.set('Access-Control-Allow-Methods', 'GET, OPTIONS')
  res.set('Access-Control-Allow-Headers', 'Content-Type')
  ...
  try {
    functions.logger.info('API request for statistics')
    ...
    functions.logger.info('Statistics retrieved successfully:', stats)
  } catch (error) {
    functions.logger.error('Error fetching statistics:', error)
    res.status(500).json({
      success: false,
      error: 'Internal server error',
      message: error.message,
...
// ============================================================================
// SIMPLEST FUNCTION: Hello World
// ============================================================================

/**
 * Simplest possible function - just returns "Hello World"
 *
 * Endpoint: GET /helloWorld
 *
 * Example:
 *   GET https://us-central1-assignment-cfc8f.cloudfunctions.net/helloWorld
 *
 * Response:
 *   {
 *     message: "Hello World",
